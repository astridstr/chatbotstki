...
line_bot_api = LineBotApi('viEClgKcjzQo/ZgYBMwYZw51KbCv0Usgt4E83GDMwUbhRzHaii8waMf8T2/6TizFt1MDJEnn48mxIbJFcJmMh0LcaGRzNe3dBwnKaSauZMu6DHnxK3b2gFlHN1mlmhLoWo2SNNYXQiAW8fx7c5rgbQdB04t89/1O/w1cDnyilFU=')
...
def handle_text_message(event):
    ...
    if(question == 'test'):
        line_bot_api.reply_message(event.reply_token, TextSendMessage(text='yeeeah'))
    else:
